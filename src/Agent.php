...
class Agent extends MobileDetect
{
    ...
    {
        return $this->retrieveUsingCacheOrResolve('cave.platform', function () {
    ...
    {
        return $this->retrieveUsingCacheOrResolve('cave.browser', function () {
            return $this->findDetectionRulesAgainstUserAgent(
    ...
    {
        return $this->retrieveUsingCacheOrResolve('cave.desktop', function () {
